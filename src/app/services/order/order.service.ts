...
export class OrderService {
  readonly menu = [
    {
      image:
        'https://avatars.mds.yandex.net/get-vertis-journal/4471904/47173cbb-a7ca-4ac7-8e9b-52560be28c2a.jpg/1600x1600',
      dish: 'Раф',
      price: 150,
    },
    {
      image:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQB3d-6NbjyDDo02PNsKReHqTjGTfN6RYVyrB2jk8mooLyZVuU_sBJnUHI&s=10',
      dish: 'Эспрессо',
      price: 180,
    },
    {
      image:
        'https://cheese-cake.ru/DesertImg/kruassan-dlya-vypekaniya-mrg-s-shokoladnoj-nachinkoj-90-g-0.jpg',
      dish: 'Круассан',
      price: 120,
    },
  ];
